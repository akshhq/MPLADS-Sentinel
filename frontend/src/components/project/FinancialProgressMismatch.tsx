...
interface FinancialProgressMismatchProps {
...
export const FinancialProgressMismatch: React.FC<FinancialProgressMismatchProps> = ({
  financialProgress,
  physicalProgress,
  disbursedAmount,
  sanctionedAmount,
        ...
        <div className="text-right self-start sm:self-auto">
          ...
          <span
            className={`ml-1.5 font-mono font-extrabold text-sm ${
              isSevereGap ? "text-rose-600 dark:text-rose-400" : "text-slate-700 dark:text-slate-300"
            }`}
          >
