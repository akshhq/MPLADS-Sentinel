...
import { FileText, Camera, BadgeIndianRupee, MapPin, CheckCircle2, AlertTriangle, ArrowRight, ShieldAlert } from "lucide-react";
        ...
        {evidenceList.map((e) => {
          ...
          return (
            <Link
              ...
              className="p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-800 hover:border-blue-400 dark:hover:border-blue-700 bg-slate-50/50 dark:bg-slate-850/40 transition-all flex flex-col justify-between group"
            >
