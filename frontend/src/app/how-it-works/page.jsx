      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
        ...
        <div className="space-y-6">
          {steps.map((step) => {
            ...
            return (<div key={step.num} className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs flex flex-col md:flex-row md:items-center gap-6">
        ...
        <div className="text-center pt-4">
          <Link href="/app/command-center" className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl text-xs font-bold text-white bg-slate-900 dark:bg-blue-600 hover:bg-slate-800">
