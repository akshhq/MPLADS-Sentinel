...
export default function LoginPage() {
  ...
  const handleDemoLogin = (targetRole: SentinelRole) => {
    ...
    setSuccessMsg(
      `Logged in as ${DEMO_PERSONAS[targetRole].full_name} (${DEMO_PERSONAS[targetRole].designation})`
    );
    setTimeout(() => router.push("/app/command-center"), 400);
  };

  const roleIcons: Record<SentinelRole, any> = {
                ...
                <>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 text-xs bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium"
                    >
