...
export default function DocumentLayoutComparePage() {
  ...
  const [uploadedDocName, setUploadedDocName] = useState<string>("Sample_Contractor_Running_Account_Bill_03.pdf");
  ...
  const handleFileSelect = async (file: File | null, customText?: string, sampleName?: string) => {
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 self-start md:self-auto"
          >
